/* 1001+ 人类艺术瑰宝 — 界面文案（中英双语）
   作品数据（含双语字段）已内联在 data.js，此处仅保留 UI 文案。
*/
window.LANG = {
ui: {
  zh: {
    title_sub:" 人类艺术瑰宝", subtitle:"跨越五万年的人类创造力",
    ...
    img_na:"暂无可公开展示的图片", view_wiki:"在 Wikipedia 查看",
    ...
    about_intro:"「1001+ 人类艺术瑰宝」是一座跨越五万年的数字艺术画廊，精选展示人类历史上的著名艺术作品——从史前壁画到当代艺术。",
  ...
  en: {
    title_sub:" Masterpieces of Human Art", subtitle:"Fifty thousand years of human creativity",
    ...
    img_na:"No public image available", view_wiki:"View on Wikipedia",
